...
```{r img-jupyter, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Jupyter Notebook", fig.retina = 2, out.width="100%"}
...
```{r mother-tongue-vs-most-at-home, fig.width=5, fig.height=4, warning=FALSE, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home"}
...
```{r mother-tongue-vs-most-at-home-labs, fig.width=5, fig.height=4, warning=FALSE, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home with x and y labels"}
ggplot(can_lang, aes(x = most_at_home, y = mother_tongue)) +
  geom_point() +
...
```{r mother-tongue-vs-most-at-home-scale, fig.width=5, fig.height=4, warning=FALSE, fig.cap = "Scatter plot of number of Canadians reporting a language as their mother tongue vs the primary language at home with log adjusted x and y axes"}
ggplot(can_lang, aes(x = most_at_home, y = mother_tongue)) +
  geom_point() +
  xlab("Language spoken most at home (number of Canadian residents)") +
  ylab("Mother tongue (number of Canadian residents)") +
...
```{r mother-tongue-vs-most-at-home-scale-props, fig.width=5, fig.height=4, warning=FALSE, fig.cap = "Scatter plot of proportion of Canadians reporting a language as their mother tongue vs the primary language at home"}
ggplot(can_lang, aes(x = most_at_home, y = mother_tongue)) +
  geom_point() +
...
knitr::include_graphics("img/file-system-for-export-to-intro-datascience.png")
```
...
```{r 02-obs, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Rows are observations in a data frame", fig.retina = 2, out.width = "100%"}
...
```{r 02-vars, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Columns are variables in a data frame", fig.retina = 2, out.width = "100%"}
...
```{r 02-vectors, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Data frame with 3 vectors", fig.retina = 2, out.width = "100%"}
...
```{r 02-vector, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Example of a numeric type vector", fig.retina = 2, out.width = "100%"}
...
```{r 02-tidy-image, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Tidy data", fig.retina = 2, out.width = "100%"}
...
```{r 03-raster-image, echo=FALSE, fig.cap = "Zoomed in `faithful`, raster (PNG, left) and vector (SVG, right) formats", fig.show="hold", out.width ="50%", out.height="50%", fig.align= "center", message =F}
knitr::include_graphics("img/faithful_zoom.png")
knitr::include_graphics("img/faithful_zoom_screenshot_svg.png")
```

<!--chapter:end:04-viz.Rmd-->
...
```{r new-repository-01, out.width="100%"}
...
```{r new-repository-02, out.width="75%"}
...
```{r new-repository-03, out.width="100%"}
...
```{r create-new-file-01, out.width="100%"}
...
```{r create-new-file-02, out.width="100%"}
...
```{r create-new-file-03, out.width="100%"}
...
```{r upload-files-01, out.width="100%"}
...
```{r upload-files-02, out.width="100%"}
...
```{r merge-conflict-01, out.width="100%"}
...
```{r merge-conflict-03, out.width="100%"}
...
```{r merge-conflict-04, out.width="100%"}
...
```{r merge-conflict-05, out.width="100%"}
...
```{r merge-conflict-06, out.width="100%"}
...
<!--chapter:end:05-version_control.Rmd-->
...
```{r 05-bc-cells, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "A malignant breast fine needle aspiration image. [Source](https://pubsonline.informs.org/doi/abs/10.1287/opre.43.4.570)", fig.retina = 2, out.width="100%"}
...
```{r 05-more, echo = FALSE, fig.cap = "3D scatterplot of symmetry, concavity and perimeter", out.width="100%"}
knitr::include_graphics("img/classification_3d.png")
#library(plotly)
#cancer %>%
#  plot_ly(
#    x = ~Perimeter,
...
```{r 06-overview, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Overview of K-nn classification", fig.retina = 2, out.width = "100%"}
...
<!--chapter:end:07-classification_continued.Rmd-->
...
```{r 07-knn-mult-viz, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "K-NN regression model’s predictions represented as a surface in 3-D space overlaid on top of the data using three predictors."}
knitr::include_graphics("img/lm-regr_3d.png")
#library(plotly)
#
...
<!--chapter:end:08-regression1.Rmd-->
...
knitr::include_graphics("img/knn-regr_3d.png")
#library(plotly)
#xvals <- seq(from = min(sacramento_train$sqft), to = max(sacramento_train$sqft), length = 50)
#yvals <- seq(from = min(sacramento_train$beds), to = max(sacramento_train$beds), length = 50)
#
...
<!--chapter:end:09-regression2.Rmd-->
...
<!--chapter:end:12-moving-to-your-own-machine.Rmd-->
