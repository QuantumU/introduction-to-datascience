...
```{r 07-knn-mult-viz, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "K-NN regression model’s predictions represented as a surface in 3-D space #overlaid on top of the data using three predictors (price, house size, and the number of bedrooms)", out.width="100%"}
include_graphics("img/knn-regr_3d.png")
#library(plotly)
#
